...
def main():
    ...
    # cteate model object
    mymodel = myModel(arch, hidden_units, True)
    ...
    # get data set
    trainloader, validloader, testloader = get_data(data_dir)
    
    # Train the model
    mymodel.train_model(model, trainloader, validloader, gpu, learning_rate, epochs, print_every)
